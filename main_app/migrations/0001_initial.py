# Generated by Django 5.1.5 on 2025-04-12 21:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_code', models.CharField(blank=True, help_text='Unique 6-character code containing letters, numbers, and special characters', max_length=6, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('start_year', 'end_year'), name='unique_session')],
            },
        ),
        migrations.CreateModel(
            name='Attendance',
